/*!
* @fichier Adafruit_ILI9341.cpp
*
* @mainpage Adafruit ILI9341 écrans TFT
*
* @section intro_sec Introduction
*
* Ceci est la documentation du pilote ILI9341 d’Adafruit pour la
* Plateforme Arduino.
*
* Cette bibliothèque fonctionne avec Adafruit 2.8 "Touch Shield V2 (SPI)
* http://www.adafruit.com/products/1651
*
* Adafruit 2,4 "TFT LCD avec écran tactile Breakout avec prise MicroSD - ILI9341
* https://www.adafruit.com/product/2478
*
* 2.8 "TFT LCD avec panneau de discussion tactile avec prise MicroSD - ILI9341
* https://www.adafruit.com/product/1770
*
* Écran LCD TFT couleur 2,2 bits 18 bits avec carte microSD - ILI9340
* https://www.adafruit.com/product/1770
*
* TFT FeatherWing - Ecran tactile 2,4 "320x240 pour toutes les plumes
* https://www.adafruit.com/product/3315
*
* Ces écrans utilisent SPI pour communiquer, 4 ou 5 broches sont nécessaires
* à l'interface (RST est facultatif).
*
* Adafruit investit temps et ressources en fournissant ce code open source,
* merci de supporter Adafruit et le matériel open-source en achetant
* produits de Adafruit!
*
* @section dependencies Dépendances
*
* Cette bibliothèque dépend de <a href="https://github.com/adafruit/Adafruit_GFX">
* Adafruit_GFX </a> étant présent sur votre système. S'il vous plaît assurez-vous d'avoir
* installé la dernière version avant d'utiliser cette bibliothèque.
*
* @section author Auteur
*
* Écrit par Limor "ladyada" Fried pour Adafruit Industries.
*
* licence de section
*
* Licence BSD, tout le texte doit être inclus dans toute redistribution.
*
*/
