...
unsigned long temps_serial=0; // la variable temps est de type long
...
float vitesse_ang = 8.1; // Vitesse Angulaire
...
//      
  ...
  if (premier_ecran)
  {
    ...
    tft.println("Theophile CHARRIER");
